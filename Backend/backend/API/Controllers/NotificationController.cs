...
namespace backend.API.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateNotificationDto dto) => Ok(await _service.CreateAsync(dto));

        [HttpPut]
        public async Task<IActionResult> Update([FromBody] UpdateNotificationDto dto) { await _service.UpdateAsync(dto); return NoContent(); }
